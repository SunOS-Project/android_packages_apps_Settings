...
import com.android.internal.util.sun.SunUtils;
...
public class GestureNavigationSettingsFragment extends DashboardFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        gestureHintPref.setOnPreferenceChangeListener((preference, newValue) -> {
            if (SunUtils.isPackageInstalled(getContext(), NEXUSLAUNCHER_PACKAGE_NAME)) {
                SunUtils.toggleOverlay(getContext(), NOGESTUREHINT_OVERLAY, !(Boolean) newValue);
                SunUtils.restartApp(NEXUSLAUNCHER_PACKAGE_NAME, getContext());
            }
